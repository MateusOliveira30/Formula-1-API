...
export const drivers = driversInRandomOrder.sort((a, b) => b.points - a.points);

export const generateTeamsArray = () => driversInRandomOrder.reduce((acc, curr) => {
    const {team, points} = curr;
